...
void lista();
void archivo();
string* paciente, * tratamiento, * hora, * descripcion,* correo;
int Alta;
...
void Altas()
{
	...
	for (int i = 0; i < Alta; i++)
	{
		...
		cout << "Favor de ingresar el correo del paciente" << endl;
		cin >> correo[i];
		cin.ignore();
...
void modificar()
{
	...
	case 7:
		i = r;
		while (getchar() != '\n');
		cout << "ingresa el correo del paciente" << endl;
		cin >> correo[i];
...
void lista()
{
	...
	for (i; i < Alta; i++)
	{
		...
		cout << "Correo del paciente: " << correo[i] << endl;
